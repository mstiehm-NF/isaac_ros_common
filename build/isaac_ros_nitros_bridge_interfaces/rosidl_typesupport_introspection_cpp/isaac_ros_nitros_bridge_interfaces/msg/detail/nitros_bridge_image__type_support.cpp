...
size_t size_function__NitrosBridgeImage__cuda_event_handle(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<uint8_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__NitrosBridgeImage__cuda_event_handle(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__NitrosBridgeImage__cuda_event_handle(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__NitrosBridgeImage__cuda_event_handle(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__NitrosBridgeImage__cuda_event_handle(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__NitrosBridgeImage__cuda_event_handle(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__NitrosBridgeImage__cuda_event_handle(untyped_member, index));
  const auto & value = *reinterpret_cast<const uint8_t *>(untyped_value);
  item = value;
}

void resize_function__NitrosBridgeImage__cuda_event_handle(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<uint8_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NitrosBridgeImage_message_member_array[10] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeImage, cuda_event_handle),  // bytes offset in struct
    nullptr,  // default value
    size_function__NitrosBridgeImage__cuda_event_handle,  // size() function pointer
    get_const_function__NitrosBridgeImage__cuda_event_handle,  // get_const(index) function pointer
    get_function__NitrosBridgeImage__cuda_event_handle,  // get(index) function pointer
    fetch_function__NitrosBridgeImage__cuda_event_handle,  // fetch(index, &value) function pointer
    assign_function__NitrosBridgeImage__cuda_event_handle,  // assign(index, value) function pointer
    resize_function__NitrosBridgeImage__cuda_event_handle  // resize(index) function pointer
  },
  {
    "uid",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_STRING,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeImage, uid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeImage, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
