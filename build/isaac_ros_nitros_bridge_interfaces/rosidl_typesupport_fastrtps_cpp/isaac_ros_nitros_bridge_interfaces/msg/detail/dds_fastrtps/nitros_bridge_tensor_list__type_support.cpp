...
#include "isaac_ros_nitros_bridge_interfaces/msg/detail/nitros_bridge_tensor_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeTensorList & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.cuda_event_handle;
  }
  // Member: uid
  cdr << ros_message.uid;
  // Member: device_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeTensorList & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: cuda_event_handle
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.cuda_event_handle[0]);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_isaac_ros_nitros_bridge_interfaces
max_serialized_size_NitrosBridgeTensorList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeTensorList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeTensorList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeTensorList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NitrosBridgeTensorList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const isaac_ros_nitros_bridge_interfaces::msg::NitrosBridgeTensorList *>(
...
static size_t _NitrosBridgeTensorList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NitrosBridgeTensorList(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NitrosBridgeTensorList__callbacks = {
...
static rosidl_message_type_support_t _NitrosBridgeTensorList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NitrosBridgeTensorList__callbacks,
...
{
  return &isaac_ros_nitros_bridge_interfaces::msg::typesupport_fastrtps_cpp::_NitrosBridgeTensorList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaac_ros_nitros_bridge_interfaces, msg, NitrosBridgeTensorList)() {
  return &isaac_ros_nitros_bridge_interfaces::msg::typesupport_fastrtps_cpp::_NitrosBridgeTensorList__handle;
}
