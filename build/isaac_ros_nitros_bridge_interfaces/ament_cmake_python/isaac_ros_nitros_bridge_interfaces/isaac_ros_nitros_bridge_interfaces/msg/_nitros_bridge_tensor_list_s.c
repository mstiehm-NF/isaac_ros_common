...
bool isaac_ros_nitros_bridge_interfaces__msg__nitros_bridge_tensor_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaac_ros_nitros_bridge_interfaces.msg._nitros_bridge_tensor_list.NitrosBridgeTensorList", full_classname_dest, 88) == 0);
  }
  isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeTensorList * ros_message = _ros_message;
  {  // header
  ...
  {  // pid
    ...
    ros_message->pid = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // fd
    ...
    assert(PyLong_Check(field));
    ros_message->fd = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // cuda_event_handle
    PyObject * field = PyObject_GetAttrString(_pymsg, "cuda_event_handle");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->cuda_event_handle.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'cuda_event_handle'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of NitrosBridgeTensorList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaac_ros_nitros_bridge_interfaces.msg._nitros_bridge_tensor_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NitrosBridgeTensorList");
  ...
  {  // pid
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->pid);
    {
  ...
  {  // fd
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->fd);
    {
  ...
  {  // cuda_event_handle
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "cuda_event_handle");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->cuda_event_handle.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->cuda_event_handle.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->cuda_event_handle.size * sizeof(uint8_t));
      assert(data != NULL);
