...
bool isaac_ros_nitros_bridge_interfaces__msg__nitros_bridge_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaac_ros_nitros_bridge_interfaces.msg._nitros_bridge_image.NitrosBridgeImage", full_classname_dest, 77) == 0);
  }
  isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of NitrosBridgeImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaac_ros_nitros_bridge_interfaces.msg._nitros_bridge_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NitrosBridgeImage");
