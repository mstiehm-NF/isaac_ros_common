...
size_t isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__size_function__NitrosBridgeImage__cuda_event_handle(
  const void * untyped_member)
{
...
const void * isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__get_const_function__NitrosBridgeImage__cuda_event_handle(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__uint8__Sequence * member =
    (const rosidl_runtime_c__uint8__Sequence *)(untyped_member);
...
void * isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__get_function__NitrosBridgeImage__cuda_event_handle(
  void * untyped_member, size_t index)
{
...
void isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__fetch_function__NitrosBridgeImage__cuda_event_handle(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const uint8_t * item =
    ((const uint8_t *)
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__get_const_function__NitrosBridgeImage__cuda_event_handle(untyped_member, index));
  uint8_t * value =
    (uint8_t *)(untyped_value);
  *value = *item;
}

void isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__assign_function__NitrosBridgeImage__cuda_event_handle(
  void * untyped_member, size_t index, const void * untyped_value)
{
  uint8_t * item =
    ((uint8_t *)
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__get_function__NitrosBridgeImage__cuda_event_handle(untyped_member, index));
  const uint8_t * value =
    (const uint8_t *)(untyped_value);
  *item = *value;
}

bool isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__resize_function__NitrosBridgeImage__cuda_event_handle(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__uint8__Sequence * member =
    (rosidl_runtime_c__uint8__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__NitrosBridgeImage_message_member_array[10] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage, cuda_event_handle),  // bytes offset in struct
    NULL,  // default value
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__size_function__NitrosBridgeImage__cuda_event_handle,  // size() function pointer
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__get_const_function__NitrosBridgeImage__cuda_event_handle,  // get_const(index) function pointer
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__get_function__NitrosBridgeImage__cuda_event_handle,  // get(index) function pointer
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__fetch_function__NitrosBridgeImage__cuda_event_handle,  // fetch(index, &value) function pointer
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__assign_function__NitrosBridgeImage__cuda_event_handle,  // assign(index, value) function pointer
    isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage__rosidl_typesupport_introspection_c__resize_function__NitrosBridgeImage__cuda_event_handle  // resize(index) function pointer
  },
  {
    "uid",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_STRING,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage, uid),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage, device_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
