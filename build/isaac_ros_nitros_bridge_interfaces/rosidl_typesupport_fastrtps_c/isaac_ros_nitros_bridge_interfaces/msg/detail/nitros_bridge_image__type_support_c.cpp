...
#include "isaac_ros_nitros_bridge_interfaces/msg/detail/nitros_bridge_image__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // cuda_event_handle, data
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // cuda_event_handle, data
#include "rosidl_runtime_c/string.h"  // encoding, uid
#include "rosidl_runtime_c/string_functions.h"  // encoding, uid
...
using _NitrosBridgeImage__ros_msg_type = isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NitrosBridgeImage__ros_msg_type * ros_message = static_cast<const _NitrosBridgeImage__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NitrosBridgeImage__ros_msg_type * ros_message = static_cast<_NitrosBridgeImage__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NitrosBridgeImage__ros_msg_type * ros_message = static_cast<const _NitrosBridgeImage__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _NitrosBridgeImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros_nitros_bridge_interfaces
size_t max_serialized_size_isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage;
    is_plain =
      (
...
static size_t _NitrosBridgeImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_isaac_ros_nitros_bridge_interfaces__msg__NitrosBridgeImage(
...
static message_type_support_callbacks_t __callbacks_NitrosBridgeImage = {
...
static rosidl_message_type_support_t _NitrosBridgeImage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NitrosBridgeImage,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_nitros_bridge_interfaces, msg, NitrosBridgeImage)() {
  return &_NitrosBridgeImage__type_support;
}
