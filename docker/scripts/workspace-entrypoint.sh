...
if [ "$RUN_ROS_MMC_SIM" == "true" ]; then
    ...
    ros2 launch mli_ros_simulator mli_ros_simulator_launch.py namespace:=/${ROS_NAMESPACE} &
    ros2 run mli_ros_simulator run_ui_button_sim --ros-args -r __ns:=/${ROS_NAMESPACE} &
fi
