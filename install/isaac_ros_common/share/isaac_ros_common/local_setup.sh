...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/isaac_ros_common"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_ros_common/environment/pythonpath.sh"
